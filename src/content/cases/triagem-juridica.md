...
resumo: >-
  ...
  de processos que simula um CRM, identifica responsáveis, alimenta um painel de acompanhamento,
  envia alertas e cria lembretes provisórios no Google Agenda marcados como [REVISAR]. A
...
meta:
  ...
  - label: "Stack"
    valor: "Make.com, API Anthropic (Claude Haiku), planilha como CRM simulado, Google Agenda"
  - label: "Status"
...
<div role="img" aria-label="Fluxo da automação: PDF do diário oficial, extração com LLM, cruzamento com a base de processos, regras determinísticas de urgência, saídas em painel, alerta e agenda, e revisão humana obrigatória no final." style="margin: 1.6em 0; font-family: var(--font-body);">
  ...
  <div aria-hidden="true" style="text-align: center; color: var(--sand); padding: 2px 0;">↓</div>
  <div style="border: 1px solid var(--line); border-radius: 10px; padding: 14px 18px; background: var(--cream-2);"><strong>5 · Saídas.</strong> Painel de acompanhamento, alerta ao responsável e lembrete provisório no Google Agenda, sempre marcado como <strong>[REVISAR]</strong>.</div>
  <div aria-hidden="true" style="text-align: center; color: var(--sand); padding: 2px 0;">↓</div>
...
<div class="placeholder">Evidências visuais planejadas: screenshot do painel e de um evento [REVISAR] na agenda, com dados fictícios.</div>
