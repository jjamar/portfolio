...
**Desenvolvimento de pessoas.** Acompanhamento individual, 1:1 quinzenal, feedbacks contínuos e autonomia progressiva. Duas promoções no time no período, incluindo a evolução de um PO Jr a Pleno em três meses e PO a PM.
...
- Área de produto não nasce de organograma, nasce de mecanismo: ownership, cadência, dado e ritual. Sem os quatro, o nome no slide não muda a operação.
- Em ambiente regulado, trazer jurídico e compliance para o início do discovery é mais rápido do que convencê-los no final.
- Desenvolver PM é trabalho de dono: feedback específico e autonomia progressiva promovem pessoas; delegação sem contexto só transfere risco.

## Competências demonstradas

Construção de área e operating model · Liderança e desenvolvimento de PMs e POs · Gestão de portfólio · Governança e rituais · OKRs e Analytics · Ambiente regulado · Gestão de stakeholders executivos · Integrações complexas · Agilidade
